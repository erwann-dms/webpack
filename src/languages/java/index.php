    ...
    <div class="bd-qt">
      ...
      <p>Nous avons pu faire l’expérience de pratiquer un projet avec Java en codant des jeux en tant que projets indépendants.  
       ...
       <br> Nous avonspus déveloper differentes Compétences tels que: 
        ...
        <br>
        <br>– Développement mobile Android : Création d’applications avec Android SDK.
        <br>
        <br>– Développement de services Web : API RESTful avec des frameworks comme Spring Boot.
        <br>
        <br>– Gestion de mémoire et optimisation : Utilisation efficace du garbage collector et des threads.
        <br>
        <br>– Utilisation de bases de données : connexion et manipulation via JDBC ou Hibernate.
        <br>
        <br>– Sécurisation des applications : gestion des sessions, des authentifications et des autorisations.
        <br>
        <br>– Applications multiplateformes : portabilité grâce au principe « Write Once, Run Anywhere ».</p>
    </div>
  </div>
