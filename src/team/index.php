        ...
        <div class="carousel-track" id="carouselTrack">
          <div class="carousel-item" alt="Slide 1">
            <div class="bd-mrwn">
              ...
              <div class="photo-container" style="border: none; overflow: visible;"><img src="../photos/logo1.png">
              </div>
              <div class="name">CodeTricks</div>
              <img
                src="<?php echo $lightmode == 'true' ? '../photos/gif/team_clair.gif' : '../photos/gif/team_sombre.gif'; ?>"
                alt="Python GIF" class="team-gif" style="height:auto;width:auto">
          ...
          <div class="carousel-item" alt="Slide 2">
            <div class="bd-mrwn">
              ...
              <div class="bio">
                <p>
                  Je m'appelle Quentin, j'ai 18 ans et je suis passionné par l'informatique et la cybersécurité. Après
                  avoir assemblé mon propre PC et appris Python en autodidacte, j'ai découvert la cybersécurité lors
                  d’une porte ouverte en 2022. J'ai ensuite intégré la Guardia Cybersecurity School, où j'ai approfondi
                  mes compétences en DevSecOps, Pentesting, SIR et OSINT. Je cherche aujourd'hui à mettre mes
                  compétences en sécurité informatique au service d'une entreprise tout en continuant à me
                  perfectionner.
            ...
            <div class="bd-mrwn">
              ...
              <div class="bio">
                <p>Je m’appelle Merwan, j’ai 18 ans et je suis originaire de Vienne, dans l'agglomération lyonnaise.
                  Passionné par l’informatique depuis de nombreuses années, je me suis intéressé il y a maintenant 2 ans
                  à la cybersécurité.
          ...
          <div class="carousel-item" alt="Slide 4">
            <div class="bd-mrwn">
              ...
              <div class="bio">
                <p>
                  20 ans passionné de SOC et de forensics je suis a votre écoute pour vous aider a créer des projets
                  sécurisés et optimisé
                </p>
              </div>
              <div class="buttons">
                <a href="https://www.linkedin.com/in/paul-burgniard/" class="button" target="_blank">
                  <i class="fab fa-linkedin"></i> linkedin
                </a>
                <a href="https://github.com/pburgniard" class="button" target="_blank">
                  <i class="fab fa-github"></i> GitHub
                </a>
              </div>
          ...
          <div class="carousel-item" alt="Slide 5">
            <div class="bd-mrwn">
              ...
              <div class="photo-container">
              <img src="../photos/erw 1.png" alt="ma photo">
              </div>
              ...
              <div class="bio">
                <p>
                  ...
                  Je me suis intéressé à la cybersécurité il y a 2 ans. J'ai pratiqué sur Root Me, TryHackMe et Hack The
                  Box.
