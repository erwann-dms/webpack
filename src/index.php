    ...
    <div class="f-container">
      <a href="/team" style="color: inherit;text-decoration: none;">
        <div class="container-Team">
          ...
          <img src="<?php echo $lightmode == 'true' ? '../photos/gif/team_clair.gif' : '../photos/gif/team_sombre.gif'; ?>" alt="Python GIF" class="team-gif" style="width:300px ;height:200px ;overflow:hidden;">
